function [] = plotOutputs_PCM(OperationCost,COP,COPsystem,Qhp,Qeh,Wgrid,Wpv,Cimp,GlobTiltIrr,...
    Ddhw,T,Text,tankEnergy,coldWaterHeight,aSH,aDHW,TimeResInputs,nDays,DailyResults,X,aThermostat)
...
xticklabels({'Day 1', 'Day 2','Day 3', 'Day 4', 'Day 5', 'Day 6', 'Day 7',''})
ylabel('T(\circC)');
legend('Ambient','Internal space','Heat-pump outlet');

% Heat output per day per technology
% =================================
...
b = bar(x,data,'stacked','FaceColor','flat') ;    
